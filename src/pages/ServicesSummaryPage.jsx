...
export default function ServicesSummaryPage({ shopId }) {
  ...
  const totalPayout      = totalSvcPay + totalCommissions
      ...
      {activeTab === 'summary' && (
        <>
          ...
          <div className="th-kpi-row">
            ...
            <KpiCard label="= Total Payout" value={fmt(totalPayout)}    accent="orange"  loading={loading} />
          </div>
          ...
          {loading ? (
            ...
            <>
              ...
              {data.map(tireman => {
                ...
                const payout    = svcPay + comTotal
                const initials  = tireman.full_name.split(' ').map(w => w[0]).slice(0, 2).join('').toUpperCase()

                return (
                  <div key={tireman.staff_id} className="ss-tireman-card" onClick={() => { setModal({ tireman, svcTotal, comTotal, svcPay, payout, initials }); setExpandedRows(new Set()) }} style={{ cursor: 'pointer' }}>
          ...
          {/* Detail Modal */}
          {modal && (() => {
            const { tireman, svcTotal, comTotal, svcPay, payout, initials } = modal
            return (
                ...
                <div className="inv-history" style={{ maxWidth: 680 }}>
                  ...
                  <div className="inv-hist-body">
                    ...
                    <div className="inv-hist-item-card">
                      ...
                      <div className="inv-hist-stats" style={{ gridTemplateColumns: '1fr 1fr' }}>
