...
// ── Constants ────────────────────────────────────────────────────────────────
const DEFAULT_TIRE_CATS = ['PCR', 'SUV', 'TBR', 'LT', 'LTB', 'MOTORCYCLE', 'TUBE', 'RECAP', 'RECAPPING', 'USED TIRE', 'TIRE']
          ...
          leftComponent={
            <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', flexWrap: 'wrap' }}>
              <div className="sl-filter-group">
                ...
                <input className="sl-filter-date" type="date" value={startDate} onChange={e => setStartDate(e.target.value)} />
                <span className="sl-filter-label">To</span>
                <input className="sl-filter-date" type="date" value={endDate} onChange={e => setEndDate(e.target.value)} />
              </div>
            </div>
          }
          filters={[
                              ...
                              {activeSug?.idx === idx && activeSug?.field === 'design' && item.design && (
                                <div className="pur-sug-drop">
                                  {dbDesigns.filter(d => {
                                    ...
                                    <div key={di} className="pur-sug-item" onMouseDown={() => {
